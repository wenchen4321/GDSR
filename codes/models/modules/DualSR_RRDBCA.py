...
class DualSR_RRDBCA(nn.Module):
    def __init__(self, in_nc, out_nc, nf, nb_e,nb_l_1,nb_l_2,nb_h_1,nb_h_2,nb_m,gc=32, upscale=4, norm_type=None, \
        ...
        super(DualSR_RRDBCA, self).__init__()
        ...
        rb_blocks_l1 = [B.RRDBCA(nf, kernel_size=3, gc=32, stride=1, bias=True, pad_type='zero', \
                              norm_type=norm_type, act_type=act_type, mode='CNA') for _ in range(nb_l_1)]
        rb_blocks_l2 = [B.RRDBCA(nf, kernel_size=3, gc=32, stride=1, bias=True, pad_type='zero', \
                              norm_type=norm_type, act_type=act_type, mode='CNA') for _ in range(nb_l_2)]
        rb_blocks_h1 = [B.RRDBSOCA(nf, kernel_size=3, gc=32, stride=1, bias=True, pad_type='zero', \
        ...
        rb_blocks_h2= [B.RRDBSOCA(nf, kernel_size=3, gc=32, stride=1, bias=True, pad_type='zero', \
